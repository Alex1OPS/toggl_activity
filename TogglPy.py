...
class Toggl():
    ...
    def setAPIKey(self, APIKey):
        ...
        ahh = base64.b64encode(bytes(authHeader, 'utf-8')).decode("utf-8")
        authHeader = "Basic " + ahh.rstrip()
    ...
    def requestRaw(self, endpoint, parameters=None):
        ...
        if parameters == None:
            ...
            endpoint = endpoint + "?" + urllib.parse.urlencode(
                parameters)  # encode all of our data for a get request & modify the URL
            return urllib.request.urlopen(
                urllib.request.Request(endpoint, headers=self.headers)).read()  # make request and read the response
    ...
    def postRequest(self, endpoint, parameters=None):
        ...
        if parameters == None:
            ...
            return urllib.request.urlopen(urllib.request.Request(endpoint, data=data,
